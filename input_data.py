"""
copy+pasted with minor changes of code from Tensorflow: 
https://github.com/tensorflow/tensorflow/blob/master/tensorflow/examples/speech_commands/input_data.py

code was tailored for their audio processing tutorial, so manipulated a bit to generalize it for 
pipelining wav files to mfcc fingerprint image preparation in a Tensorflow graph
"""
